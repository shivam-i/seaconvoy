...
function SeaconvoyDesc() {
  return (
    <div className="seaconvoy-desc">
      <div class="seaconvoy-desc-container">
      <img src="./images/seaconvoy-desc-heading.png" alt="" class="seaconvoy-desc-heading" width="550px"/>
      <div class="seaconvoy-desc-text">
    ...
    <img class="seaconvoy-desc-bg-pic" src="./images/seaconvoy-desc-pic.png" alt=""/>
    </div>
  );
}
